...
ALTER TABLE CTTON ADD CONSTRAINT fk_ctton_ch FOREIGN KEY (MA_CH) REFERENCES CUAHANG(MACH);
ALTER TABLE CTTON ADD CONSTRAINT fk_ctton_kho FOREIGN KEY (MA_KHO) REFERENCES KHO(MAKHO);
